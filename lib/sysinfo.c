 ...
 * System information
 *
 * Collects and reports system hardware information including CPU count,
 * memory statistics, and heap usage.
 */
 ...
 *
 * Queries hardware and memory subsystems to populate the sysinfo structure.
 */
